...
describe Restaurant do
  ...
  describe ".new" do
    ...
    it "has an image url" do
      expect(restaurant.image_url).to eq(
        "https://res-1.cloudinary.com/simpleview/image/fetch/c_fill,f_auto,h_202,q_60,w_267/https://boston.simpleviewcrm.com/images/listings/original_BlueDragonLunchSalmon0.jpg"
      )
    end
    ...
    it "has a lunch menu link" do
      expect(restaurant.lunch_menu_link).to eq(
        "https://boston.simpleviewcrm.com/docs/amenities/BD%20Dine%20Out%20Lunch%2020171.pdf"
      )
    end
    ...
    it "has a dinner menu link" do
      expect(restaurant.dinner_menu_link).to eq(
        "https://boston.simpleviewcrm.com/docs/amenities/BD%20Dine%20Out%20Dinner%202017.pdf"
      )
    end
